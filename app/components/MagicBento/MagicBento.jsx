...
const DEFAULT_GLOW_COLOR = '107, 92, 165'; // Your --accent2 color
...
const ParticleCard = ({
  ...
  useEffect(() => {
    ...
    const handleClick = e => {
      // IMPORTANT: Call onClick callback
  ...
  return (
    <div
      ...
      onClick={(e) => {
        // Ensure click is captured and passed to handler
        if (onClick && typeof onClick === 'function') {
          onClick(e);
        }
      }}
...
const useMobileDetection = () => {
  ...
  useEffect(() => {
    ...
    const checkPerformance = () => {
      ...
      setIsSlowDevice(slowConnection || lowMemory || false);
    };
...
const MagicBento = ({
  ...
  const shouldDisableAnimations = disableAnimations || isMobile.isMobile;
      ...
      <BentoCardGrid gridRef={gridRef}>
        {cards.map((card, index) => {
          ...
          const handleCardClick = (e) => {
            console.log('Card clicked in MagicBento:', card);
            ...
            return (
              ...
              >
                ...
                <div className="magic-bento-card__content">
                  ...
                  {card.count && <div className="magic-bento-card__count">{card.count} games</div>}
                </div>
              </ParticleCard>
            );
          }
