        ...
        <div className="footer-content">
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links">
              <li><Link href="/nsp">NSP Games</Link></li>
              <li><Link href="/switch">Nintendo Switch</Link></li>
              <li><Link href="/pc">PC Games</Link></li>
              <li><Link href="/mac">Mac Games</Link></li>
              <li><Link href="/android">Android Games</Link></li>
            </ul>
          </div>
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links">
              <li><Link href="/nsp/action">Action</Link></li>
              <li><Link href="/nsp/rpg">RPG</Link></li>
              <li><Link href="/nsp/adventure">Adventure</Link></li>
              <li><Link href="/pc/strategy">Strategy</Link></li>
              <li><Link href="/nsp/puzzle">Puzzle</Link></li>
            </ul>
          </div>
